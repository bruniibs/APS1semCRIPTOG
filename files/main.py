...
# ------------------------ PROGRAMA PRINCIPAL ------------------------------
def main():
    print("=== Criptografia César (fixo=3) + XOR ===")
    ...
    if opcao == "1":
        ...
        print(cript.encode("latin1")) #mostra bytes legiveis
    elif opcao == "2":
        cript = bytes(mensagem, "latin1").decode("latin1")
        decript = descriptografar(cript, chave_xor)
